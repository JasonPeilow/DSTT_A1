...
x1a = training(:,6); %Train acc - Explanatory Variable
y1a = training(:,1); %Train mpg - Dependant Variable
nx1a = testing(:,6); %Testing acc - Explanatory Variable
ny1a = testing(:,1); %Testing mpg - Dependant Variable
