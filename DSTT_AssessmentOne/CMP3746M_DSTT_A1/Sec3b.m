...
title('Horsepower V Mpg: Trained Linear Regression Model (95% Prediction Interval)')
...
xlabel('Horsepower')
ylabel('Miles per Gallon')
title('Horsepower V Mpg: Trained Linear Regression Model (Model Comparison)')
...
xlabel('Horsepower')
ylabel('Miles per Gallon')
title('Horsepower V Mpg: Test Linear Model')
hold off 
...
xlabel('Horsepower') 
ylabel('Miles per Gallon') 
title('Horsepower V Mpg: Ground Truth and Prediction')
