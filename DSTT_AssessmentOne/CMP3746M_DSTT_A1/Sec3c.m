...
xlabel('Weight')
ylabel('Horsepower')
title('Weight V Horsepower: Trained Linear Regression Model (95% Prediction Interval)')
...
xlabel('Weight')
ylabel('Horsepower')
title('Weight V Horsepower: Trained Linear Regression Model (Model Comparison)')
...
xlabel('Weight')
ylabel('Horsepower')
title('Weight V Horsepower: Test Linear Model')
hold off 
...
plot(GTruthPredModel)
xlabel('Weight') 
ylabel('Horsepower') 
title('Weight V Horsepower: Ground Truth and Prediction')
...
%-------- TASK 8e: GROUND TRUTH and PREDICTION COMPARISON (Min, Med, Max) ------
...
%-------- TASK 8f: TESTING THE HYPOTHESES ------

norm = normpdf(yHat,0,1);
[h,p] = kstest(norm)
